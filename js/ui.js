...
Aether.UI.prototype._populateSettings = function() {
  ...
  var ttsLangEl = document.getElementById('set-tts-lang');
  if (ttsLangEl) ttsLangEl.value = s.ttsLang || 'auto';
  var ttsProvEl = document.getElementById('set-tts-provider');
  if (ttsProvEl) ttsProvEl.value = s.ttsProvider || 'gemini';
...
Aether.UI.prototype._saveSettings = function() {
  ...
  var ttsLangEl = document.getElementById('set-tts-lang');
  if (ttsLangEl) s.ttsLang = ttsLangEl.value;
  var ttsProvEl = document.getElementById('set-tts-provider');
  if (ttsProvEl) s.ttsProvider = ttsProvEl.value;
